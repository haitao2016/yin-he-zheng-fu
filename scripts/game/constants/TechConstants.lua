...
M.TECHS = {
    ...
    WARP_DRIVE = { id = "WARP_DRIVE", name = "曲速引擎", tier = 2, cost = { minerals = 700, crystal = 80, energy = 300 }, time = 150, prereqs = { "HULL_ALLOY" }, bonus = { movementSpeedMult = 1.5 }, desc = "舰队移动速度+50%。" },
    ...
    -- Tier 3
    VOID_ANCHOR = { id = "VOID_ANCHOR", name = "虚空锚定", tier = 3, cost = { minerals = 1500, crystal = 200, energy = 500 }, time = 240, prereqs = { "WARP_DRIVE" }, bonus = { enemySpeedMult = 0.7 }, desc = "敌方舰队移动速度-30%。" },
    NOVA_CANNON = { id = "NOVA_CANNON", name = "新星炮", tier = 3, cost = { minerals = 1800, crystal = 300, energy = 600, nuclear = 100 }, time = 280, prereqs = { "ADVANCED_WEAPONS" }, bonus = { aoeRadiusMult = 1.8, attackMult = 1.5 }, desc = "AOE半径+80%，全体伤害+50%。" },
    FORTRESS_PROTOCOL = { id = "FORTRESS_PROTOCOL", name = "要塞协议", tier = 3, cost = { minerals = 2000, crystal = 250, energy = 800 }, time = 300, prereqs = { "DEFENSE_MATRIX" }, bonus = { baseShieldMult = 2.0, baseShieldRegen = 0.01 }, desc = "基地护盾最大值翻倍，每秒恢复1%基地护盾。" },
    QUANTUM_CORE = { id = "QUANTUM_CORE", name = "量子核心", tier = 3, cost = { minerals = 2200, crystal = 350, energy = 700 }, time = 320, prereqs = { "RAPID_REFINE", "CRYSTAL_PROCESS" }, bonus = { researchSpeedMult = 1.5, baseUpgradeCostMult = 0.8 }, desc = "科研速度+50%，核心升级费用-20%。" },
    -- Tier 4 双路线
    PHASE_DRIVE = { id = "PHASE_DRIVE", name = "相位驱动", tier = 4, cost = { minerals = 3000, crystal = 500, energy = 1000, nuclear = 200 }, time = 400, prereqs = { "WARP_DRIVE", "VOID_ANCHOR" }, bonus = { movementSpeedMult = 2.0, stealth = true }, desc = "舰队速度再+50%，获得隐形能力。" },
    STELLAR_SYNC = { id = "STELLAR_SYNC", name = "星际同步", tier = 4, cost = { minerals = 3000, crystal = 500, energy = 1000 }, time = 400, prereqs = { "QUANTUM_CORE", "SOLAR_EFFICIENCY" }, bonus = { globalOutputMult = 1.25, researchSpeedMult = 1.3 }, desc = "全局产出+25%，科研+30%。" },
    STELLAR_ENGINE = { id = "STELLAR_ENGINE", name = "恒星引擎", tier = 4, cost = { minerals = 3500, crystal = 600, energy = 1500, nuclear = 300 }, time = 420, prereqs = { "PHASE_DRIVE", "ADVANCED_WEAPONS" }, bonus = { movementSpeedMult = 2.0, battleStartSpeedBoost = 1.0 }, desc = "全局移动速度+60%，战斗开局获得初始加速。" },
    QUANTUM_FACTORY = { id = "QUANTUM_FACTORY", name = "量子工厂", tier = 4, cost = { minerals = 3500, crystal = 600, energy = 1200 }, time = 420, prereqs = { "QUANTUM_CORE", "RAPID_REFINE" }, bonus = { buildSpeedMult = 2.0, baseUpgradeCostMult = 0.75 }, desc = "舰船建造速度翻倍，升级费用-25%。" },
    VOID_FLEET = { id = "VOID_FLEET", name = "虚空舰队", tier = 4, cost = { minerals = 3500, crystal = 600, energy = 1500, nuclear = 300 }, time = 420, prereqs = { "NOVA_CANNON", "VOID_ANCHOR" }, bonus = { enemyWaveMult = 0.7, enemyDamageMult = 0.8 }, desc = "敌方舰队生成-30%，敌舰伤害-20%。" },
    FORTRESS_PROTOCOL_II = { id = "FORTRESS_PROTOCOL_II", name = "要塞协议II", tier = 4, cost = { minerals = 3500, crystal = 600, energy = 1500, nuclear = 200 }, time = 420, prereqs = { "FORTRESS_PROTOCOL" }, bonus = { baseShieldMult = 3.0, baseShieldRegen = 0.02, counterShield = true }, desc = "基地护盾最大值3倍，每秒恢复2%，受攻击时触发反击护盾。" },
    -- Tier 5 终极科技
