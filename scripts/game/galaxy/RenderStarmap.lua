...
-- 内部常量（仅本模块使用）
-- ============================================================================
local DIPLO_REL_COLORS = {
    compete   = { 255, 80, 80, 100 },
    neutral   = { 160, 160, 160, 60 },
    cooperate = { 80, 220, 120, 100 },
}
local DIPLO_FACTION_COLORS = {
    trade_union  = { 255, 200, 80 },
    star_guild   = { 100, 200, 255 },
    relic_keeper = { 180, 120, 255 },
}
