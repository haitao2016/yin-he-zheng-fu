...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `network/Client.lua.bak` | backup |
| `create_subfile` | `network/Client_evolution_tree.lua` | 数据表模块（EVOLUTION_TREE 定义） |
| `create_subfile` | `network/Client_scalars.lua` | 数据表模块（scalars 定义） |
| `create_subfile` | `network/Client_general.lua` | general 相关函数（42 个函数，约 389 行代码） |
| `create_subfile` | `network/Client_core.lua` | Client 相关函数（4 个函数，约 34 行代码） |
| `create_refactored_skeleton` | `network/Client.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/GalaxyScene.lua.bak` | backup |
| `create_subfile` | `game/GalaxyScene_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/GalaxyScene_galaxy_scene.lua` | GalaxyScene 相关函数（44 个函数，约 247 行代码） |
| `create_subfile` | `game/GalaxyScene_general.lua` | general 相关函数（25 个函数，约 230 行代码） |
| `create_refactored_skeleton` | `game/GalaxyScene.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/FleetPanel.lua.bak` | backup |
| `create_subfile` | `game/ui/FleetPanel_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/ui/FleetPanel_fleet_panel.lua` | FleetPanel 相关函数（6 个函数，约 136 行代码） |
| `create_subfile` | `game/ui/FleetPanel_general.lua` | general 相关函数（5 个函数，约 18 行代码） |
| `create_refactored_skeleton` | `game/ui/FleetPanel.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/BattleScene.lua.bak` | backup |
| `create_subfile` | `game/BattleScene_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/BattleScene_battle_environments.lua` | 数据表模块（BATTLE_ENVIRONMENTS 定义） |
| `create_subfile` | `game/BattleScene_formation_config.lua` | 数据表模块（FORMATION_CONFIG 定义） |
| `create_subfile` | `game/BattleScene_ship.lua` | 数据表模块（ship 定义） |
| `create_subfile` | `game/BattleScene_battle_scene.lua` | BattleScene 相关函数（7 个函数，约 216 行代码） |
| `create_subfile` | `game/BattleScene_general.lua` | general 相关函数（11 个函数，约 209 行代码） |
| `create_refactored_skeleton` | `game/BattleScene.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/GalaxyEvents.lua.bak` | backup |
| `create_subfile` | `game/GalaxyEvents_event_types.lua` | 数据表模块（EVENT_TYPES 定义） |
| `create_subfile` | `game/GalaxyEvents_disaster_types.lua` | 数据表模块（DISASTER_TYPES 定义） |
| `create_subfile` | `game/GalaxyEvents_endgame_crisis_types.lua` | 数据表模块（ENDGAME_CRISIS_TYPES 定义） |
| `create_subfile` | `game/GalaxyEvents_galaxy_events.lua` | GalaxyEvents 相关函数（29 个函数，约 139 行代码） |
| `create_refactored_skeleton` | `game/GalaxyEvents.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/GameUI.lua.bak` | backup |
| `create_subfile` | `game/GameUI_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/GameUI_c.lua` | 数据表模块（C 定义） |
| `create_subfile` | `game/GameUI_game_ui.lua` | GameUI 相关函数（43 个函数，约 318 行代码） |
| `create_subfile` | `game/GameUI_general.lua` | general 相关函数（6 个函数，约 42 行代码） |
| `create_refactored_skeleton` | `game/GameUI.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/EndGamePanel.lua.bak` | backup |
| `create_subfile` | `game/ui/EndGamePanel_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/ui/EndGamePanel_general.lua` | general 相关函数（11 个函数，约 135 行代码） |
| `create_subfile` | `game/ui/EndGamePanel_end_game_panel.lua` | EndGamePanel 相关函数（12 个函数，约 33 行代码） |
| `create_refactored_skeleton` | `game/ui/EndGamePanel.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/battle/BattleAI.lua.bak` | backup |
| `create_subfile` | `game/battle/BattleAI_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/battle/BattleAI_battle_ai.lua` | BattleAI 相关函数（15 个函数，约 189 行代码） |
| `create_subfile` | `game/battle/BattleAI_general.lua` | general 相关函数（7 个函数，约 60 行代码） |
| `create_refactored_skeleton` | `game/battle/BattleAI.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/GalaxyPanels.lua.bak` | backup |
| `create_subfile` | `game/ui/GalaxyPanels_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/ui/GalaxyPanels_m.lua` | M 相关函数（9 个函数，约 442 行代码） |
| `create_refactored_skeleton` | `game/ui/GalaxyPanels.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/PlanetPanel.lua.bak` | backup |
| `create_subfile` | `game/ui/PlanetPanel_planet_panel.lua` | PlanetPanel 相关函数（5 个函数，约 48 行代码） |
| `create_subfile` | `game/ui/PlanetPanel_general.lua` | general 相关函数（7 个函数，约 31 行代码） |
| `create_refactored_skeleton` | `game/ui/PlanetPanel.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `network/ClientBattle.lua.bak` | backup |
| `create_subfile` | `network/ClientBattle_explorer_task_templates.lua` | 数据表模块（EXPLORER_TASK_TEMPLATES 定义） |
| `create_subfile` | `network/ClientBattle_m.lua` | M 相关函数（21 个函数，约 115 行代码） |
| `create_refactored_skeleton` | `network/ClientBattle.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `network/ClientSetup.lua.bak` | backup |
| `create_subfile` | `network/ClientSetup_battle_state_.lua` | 数据表模块（battleState_ 定义） |
| `create_refactored_skeleton` | `network/ClientSetup.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `network/ClientMenus.lua.bak` | backup |
| `create_subfile` | `network/ClientMenus_client_menus.lua` | ClientMenus 相关函数（13 个函数，约 204 行代码） |
| `create_refactored_skeleton` | `network/ClientMenus.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/battle/RenderOverlays.lua.bak` | backup |
| `create_subfile` | `game/battle/RenderOverlays_general.lua` | general 相关函数（11 个函数，约 186 行代码） |
| `create_refactored_skeleton` | `game/battle/RenderOverlays.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/galaxy/RenderStarmap.lua.bak` | backup |
| `create_subfile` | `game/galaxy/RenderStarmap_m.lua` | M 相关函数（8 个函数，约 126 行代码） |
| `create_refactored_skeleton` | `game/galaxy/RenderStarmap.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/TechPanel.lua.bak` | backup |
| `create_subfile` | `game/ui/TechPanel_general.lua` | general 相关函数（4 个函数，约 42 行代码） |
| `create_refactored_skeleton` | `game/ui/TechPanel.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/AchievementSystem.lua.bak` | backup |
| `create_subfile` | `game/AchievementSystem_achievements.lua` | 数据表模块（ACHIEVEMENTS 定义） |
| `create_subfile` | `game/AchievementSystem_achievement_rewards.lua` | 数据表模块（ACHIEVEMENT_REWARDS 定义） |
| `create_subfile` | `game/AchievementSystem_achievement_system.lua` | AchievementSystem 相关函数（15 个函数，约 91 行代码） |
| `create_refactored_skeleton` | `game/AchievementSystem.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/PirateAI.lua.bak` | backup |
| `create_subfile` | `game/PirateAI_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/PirateAI_general.lua` | general 相关函数（13 个函数，约 125 行代码） |
| `create_refactored_skeleton` | `game/PirateAI.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/galaxy/RenderHUD.lua.bak` | backup |
| `create_subfile` | `game/galaxy/RenderHUD_m.lua` | M 相关函数（11 个函数，约 315 行代码） |
| `create_refactored_skeleton` | `game/galaxy/RenderHUD.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/systems/DiplomacySystem.lua.bak` | backup |
| `create_subfile` | `game/systems/DiplomacySystem_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/systems/DiplomacySystem_general.lua` | general 相关函数（24 个函数，约 141 行代码） |
| `create_refactored_skeleton` | `game/systems/DiplomacySystem.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/battle/RenderHUD.lua.bak` | backup |
| `create_subfile` | `game/battle/RenderHUD_general.lua` | general 相关函数（9 个函数，约 174 行代码） |
| `create_refactored_skeleton` | `game/battle/RenderHUD.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/ReplayPlayer.lua.bak` | backup |
| `create_subfile` | `game/ui/ReplayPlayer_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/ui/ReplayPlayer_general.lua` | general 相关函数（11 个函数，约 139 行代码） |
| `create_subfile` | `game/ui/ReplayPlayer_replay_player.lua` | ReplayPlayer 相关函数（6 个函数，约 20 行代码） |
| `create_refactored_skeleton` | `game/ui/ReplayPlayer.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/TutorialSystem.lua.bak` | backup |
| `create_subfile` | `game/ui/TutorialSystem_phases.lua` | 数据表模块（PHASES 定义） |
| `create_subfile` | `game/ui/TutorialSystem_tutorial_system.lua` | TutorialSystem 相关函数（15 个函数，约 76 行代码） |
| `create_refactored_skeleton` | `game/ui/TutorialSystem.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/TopBar.lua.bak` | backup |
| `create_subfile` | `game/ui/TopBar_part2.lua` | 第 2 部分（通用分段，建议手动分析后改为有意义的命名） |
| `create_refactored_skeleton` | `game/ui/TopBar.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
...
| 操作 | 目标文件 | 说明 |
|------|----------|------|
| `backup` | `game/ui/SettingsPanel.lua.bak` | backup |
| `create_subfile` | `game/ui/SettingsPanel_config.lua` | 配置常量（从原文件拆分独立模块） |
| `create_subfile` | `game/ui/SettingsPanel_settings_panel.lua` | SettingsPanel 相关函数（20 个函数，约 68 行代码） |
| `create_refactored_skeleton` | `game/ui/SettingsPanel.lua.refactored` | 重构后的主文件骨架（包含 require 语句，具体逻辑需要手动迁移） |
